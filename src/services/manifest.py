...
It is a JSON file inside CHROMA_DIR, written atomically (temp file + os.replace) under a
lock, so the index and its manifest are wiped together and a reader never observes a
half-written file.
"""
import json
import os
